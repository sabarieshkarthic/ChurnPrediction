...
#sns.lmplot(data=cdf,x='MonthlyCharges',y='TotalCharges',fit_reg=False)
plt.show() 
...
#X_train['MonthlyCharges']=np.log(X_train['MonthlyCharges']+1)
#X_train['TotalCharges']=np.log(X_train['TotalCharges']+1)
